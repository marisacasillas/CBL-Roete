...
**The CBL model was well-suited for this intial investigation into sentence processing over age given its use of BTP, its (computational-level) psycholinguistic plausibility, its past performance on similar tasks, and its proposed continuity over development. However, the model is not without limitations. <!--select from R3's comments-->**
**If we were to speculate on how this issue could be resolved ... **
